...
Open questions remain around applying the Supabase migration, real provider credentials, deployed webhook behavior, Printful credentials/catalog variants, push subscription implementation, and phone camera testing.
