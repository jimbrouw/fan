export type TeamProfile = {
  id: string;
  name: string;
  group: "Premier League" | "EFL Championship" | "EFL League One" | "EFL League Two" | "International" | "World Cup 2026" | "International Giants" | "Custom";
  primary: string;
  accent: string;
  kitNotes: string;
  trophy?: string;
...
export const teamProfiles: TeamProfile[] = [
  ...
  // Premier League
  { id: "arsenal", name: "Arsenal", group: "Premier League", primary: "#d71920", accent: "#ffffff", kitNotes: "2026/27 kit data available: adidas home, away, and third shirts listed by Football Kit Archive. Home identity remains red body with white sleeves and Premier League sleeve context.", trophy: "Premier League Trophy" },
  { id: "aston-villa", name: "Aston Villa", group: "Premier League", primary: "#95bfe5", accent: "#670e36", kitNotes: "2026/27 kit data available: adidas home, away, and third shirts listed by Football Kit Archive. Home identity remains claret body with sky-blue sleeves.", trophy: "Premier League Trophy" },
  ...
  { id: "brighton", name: "Brighton & Hove Albion", group: "Premier League", primary: "#0057b8", accent: "#ffffff", kitNotes: "2026/27 third kit listed by Football Kit Archive; home identity remains blue and white stripes until the new home kit is released." },
  { id: "burnley", name: "Burnley", group: "EFL Championship", primary: "#6c1d45", accent: "#99d6ea", kitNotes: "Claret shirt with sky-blue detailing, white shorts, traditional Burnley palette." },
  { id: "chelsea", name: "Chelsea", group: "Premier League", primary: "#034694", accent: "#ffffff", kitNotes: "2026/27 kit data available: Nike home and away shirts listed by Football Kit Archive. Home identity remains royal blue with clean Chelsea detailing." },
  ...
  { id: "leeds", name: "Leeds United", group: "Premier League", primary: "#ffffff", accent: "#ffcd00", kitNotes: "2026/27 kit data available: adidas home, away, and third shirts listed by Football Kit Archive. Home identity remains white with blue and yellow accent details." },
  { id: "liverpool", name: "Liverpool", group: "Premier League", primary: "#c8102e", accent: "#f6eb61", kitNotes: "2026/27 kit data available: adidas home, away, and third shirts listed by Football Kit Archive. Home identity remains full red with white detailing.", trophy: "Premier League Trophy" },
  { id: "man-city", name: "Manchester City", group: "Premier League", primary: "#6cabdd", accent: "#ffffff", kitNotes: "2026/27 kit data available: Puma home, away, and third shirts listed by Football Kit Archive. Home identity remains sky blue with City detailing.", trophy: "Premier League Trophy" },
  { id: "man-united", name: "Manchester United", group: "Premier League", primary: "#da291c", accent: "#111111", kitNotes: "2026/27 kit data available: adidas home, away, and third shirts listed by Football Kit Archive. Home identity remains red with white and black detailing.", trophy: "Premier League Trophy" },
  { id: "newcastle", name: "Newcastle United", group: "Premier League", primary: "#111111", accent: "#ffffff", kitNotes: "2026/27 kit data available: adidas home and away shirts listed by Football Kit Archive. Home identity remains black and white stripes." },
  { id: "nottingham-forest", name: "Nottingham Forest", group: "Premier League", primary: "#dd0000", accent: "#ffffff", kitNotes: "2026/27 home kit listed by Football Kit Archive: red adidas home identity with white detailing.", nickname: "Tricky Trees", visualMotifs: ["subtle tree silhouettes", "playful forest hints", "red-and-white supporter flags"] },
  ...
  { id: "tottenham", name: "Tottenham Hotspur", group: "Premier League", primary: "#ffffff", accent: "#132257", kitNotes: "2026/27 kit data available: Nike home and away shirts listed by Football Kit Archive. Home identity remains white with navy Spurs detailing." },
  { id: "west-ham", name: "West Ham United", group: "EFL Championship", primary: "#7a263a", accent: "#1bb1e7", kitNotes: "Claret shirt with blue sleeves or blue accents, white shorts." },
  { id: "wolves", name: "Wolverhampton Wanderers", group: "EFL Championship", primary: "#fdb913", accent: "#231f20", kitNotes: "Old-gold shirt with black trim, black shorts, strong Wolves contrast." },
  { id: "coventry", name: "Coventry City", group: "Premier League", primary: "#0b66a8", accent: "#ffffff", kitNotes: "Sky blue shirt with white trim, 2026/27 Premier League return." },
  { id: "hull", name: "Hull City", group: "Premier League", primary: "#f5a11c", accent: "#000000", kitNotes: "Amber and black tiger stripes or accents, 2026/27 Premier League return." },
  { id: "ipswich", name: "Ipswich Town", group: "Premier League", primary: "#002fa7", accent: "#ffffff", kitNotes: "Royal blue shirt with white accents, 2026/27 Premier League return." },
  ...
  { id: "notts-county", name: "Notts County", group: "EFL League Two", primary: "#000000", accent: "#ffffff", kitNotes: "Classic black and white striped shirt, black shorts, oldest professional league club." },
